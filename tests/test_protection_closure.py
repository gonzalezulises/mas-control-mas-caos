#!/usr/bin/env python3
"""
Test: Protection Closure for chapter_blueprints in working architecture version.
...
def get_working_blueprints(data: dict) -> list:
    """Extract chapter_blueprints from architecture_versions with status=working."""
